...
class TestDataExtractors(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.all_player_statistics.to_csv('test/data/all_players_statistics.csv', index=False)

        # Crear instancia de CsvDataExtractor
        cls.csv_extractor = CsvDataExtractor(base_dir='test/data')
